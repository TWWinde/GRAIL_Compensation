...
if __name__ == "__main__":
    ...
    # pruner = ViT_WandaAwareFolding(model, compression_ratio=COMPRESSION_RATIO, beta_row=0.5, ignore_cls=True)

    # decoupled pruning and compensation
    # Apply Wanda pruning
    pruner = ViT_WandaPruning(model, compression_ratio=COMPRESSION_RATIO, mode="proj_cols")
    ...
    print("\n=== Evaluation AFTER compression (before conpensation and REPAIR) ===")
    ...
    # conpensation step
    compensator = Vit_PruneCompensation(pruned_model, ridge_lambda=1e-3)
