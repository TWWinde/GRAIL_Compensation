...
def get_ptb(nsamples, seed, seqlen, tokenizer):
    ...
    """
    # Load train and test datasets from raw text files to avoid script issues
    data_files = {
    ...
    ptb_dataset = load_dataset('text', data_files=data_files)
    traindata = ptb_dataset['train']
    testdata = ptb_dataset['validation']
...
def get_c4(nsamples, seed, seqlen, tokenizer):
    ...
    dataset = load_dataset('allenai/c4', 'en', data_files=data_files, verification_mode='no_checks')
