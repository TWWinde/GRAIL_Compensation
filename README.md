...
- The code folder is modified from https://github.com/TWWinde/GRAIL_LLM and [https://github.com/nanguoyu/simple_model_folding_public](https://github.com/nanguoyu/simple_model_folding_public)
